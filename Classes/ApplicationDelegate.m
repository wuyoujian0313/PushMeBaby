...
- (id)init {
	self = [super init];
	if(self != nil) {
        //ae0cf7b0 d344a9de 818e36e3 28ac886e 7a9f5bc6 2a1be328 566492a5 e6d2712b
        //958a175b 6bbb529a 53a2f3b7 a82e5483 b877e411 e1252fa1 b1751745 f0476377
		self.deviceToken = @"958a175b6bbb529a53a2f3b7a82e5483b877e411e1252fa1b1751745f0476377";
		self.payload = @"{\"aps\":{\"alert\":\"测试消息\",\"badge\":1,\"sound\":\"default.wav\"}}";
		self.certificate = [[NSBundle mainBundle] pathForResource:@"apns_tong" ofType:@"cer"];
	}
	return self;
}
...
- (IBAction)push:(id)sender {
    ...
    // mod by youjian.wu
    NSMutableString* tokenString = [NSMutableString stringWithCapacity:0];
    [tokenString setString:self.deviceToken];
    
    if ([self.deviceToken length] <=32) {
        int i = 1;
        int index = i * 8;
        for ( ;i <= 7; i++) {
            [tokenString insertString:@" " atIndex:index];
